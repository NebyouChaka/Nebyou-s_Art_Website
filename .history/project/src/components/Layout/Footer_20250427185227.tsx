        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-primary-200 hover:text-white transition duration-300">
                <Instagram size={20} />
              </a>
              ...
              <a href="mailto:info@nebyouchaka.com" className="text-primary-200 hover:text-white transition duration-300">
                <Mail size={20} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <address className="not-italic text-primary-200">
              ...
              <p>Email: info@nebyouchaka.com</p>
            </address>
          </div>
        </div>
