      ...
      <div className="relative container h-full flex items-center">
        ...
        >
          ...
          >
            <Link 
              to="/gallery" 
              className="inline-block bg-white text-gray-900 px-6 py-3 border border-transparent rounded-md text-base font-medium hover:bg-gray-50 transition duration-300"
            >
              Explore Gallery
            </Link>
          </motion.div>
