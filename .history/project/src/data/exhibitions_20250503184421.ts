...
export const exhibitions: Exhibition[] = [
  {
    ...
    description: 'A group exhibition exploring themes of cultural memory, identity, and the diaspora experience through a series of large-scale paintings and mixed media works. The exhibition features Nebyou Chaka\'s most recent body of work, created over the past two years.',
    location: 'HanaAzeb Art Gallery, Sneilville, GA',
    startDate: '2023-06-10',
    endDate: '2023-08-15',
    imageUrl: 'public/artworks/Final_flyer_design1.png',
    type: 'group',
  ...
  },
  {
    ...
    description: 'This thematic exhibition brings artist who explore aspects of African identity in the 21st century. Nebyou Chaka contributes works that examine the fluidity of cultural identity and the impact of migration on artistic practice.',
    location: 'AllianceFrancaise art center Atlanta, GA',
