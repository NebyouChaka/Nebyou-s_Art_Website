...
export const exhibitions: Exhibition[] = [
  {
    ...
    location: 'Contemporary Arts Center, San Francisco, CA',
  ...
  },
  {
    ...
    location: 'Museum of Contemporary African Art, Los Angeles, CA',
  ...
  },
  {
    ...
    description: 'An upcoming group exhibition where Nebyou Chaka will debut a new series of works exploring concepts of belonging, community, and place. The exhibition will feature paintings, sculptures, and an immersive installation.',
    location: 'Eastside Gallery, Seattle, WA',
    startDate: '2025-04-4',
    endDate: '2025-04-8',
