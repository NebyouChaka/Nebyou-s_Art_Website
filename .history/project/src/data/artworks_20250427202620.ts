...
export const artworks: Artwork[] = [
  {
    ...
    year: 2023,
    price: 3800,
    imageUrl: 'project\public\artworks\Untitled -1.jpg',
    description: 'This painting explores the boundary between physical and spiritual landscapes. Inspired by the highlands of Ethiopia, it represents both an actual place and an emotional state, using layers of color to suggest depth and time.',
    isSold: false,
    isFeatured: true
  },
  {
    id: 'artwork-2',
    title: 'Identity Fragment #3',
    medium: 'Mixed Media',
    dimensions: '24 x 30 inches',
    year: 2023,
    price: 2400,
    imageUrl: 'https://images.pexels.com/photos/3705944/pexels-photo-3705944.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    description: 'Part of a series examining identity through fragmented imagery. This piece incorporates traditional patterns and symbols with contemporary abstract elements, exploring the intersection of cultural heritage and modern existence.',
    isSold: false,
    isFeatured: true
  },
  {
