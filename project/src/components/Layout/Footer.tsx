        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.facebook.com/profile.php?id=100068950540361#" target="_blank" rel="noopener noreferrer" className="text-primary-200 hover:text-white transition duration-300">
                <Facebook size={20} />
              </a>
              <a href="mailto:nebyouchaka@gmail.com" className="text-primary-200 hover:text-white transition duration-300">
                <Mail size={20} />
              </a>
            </div>
          </div>
